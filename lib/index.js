...
/** Runtime schema for the plugin row. Schemastery fields are optional by default; the
 *  embedded skills dir is fixed to the package path, so the plugin takes no config. */
